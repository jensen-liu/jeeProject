...
public class PermissionInsertVO implements Serializable {
	...
	public String toString() {
		return "PermissionInsertVO [parentId=" + parentId + ", name=" + name + ", href=" + href + ", target=" + target
				+ ", icon=" + icon + ", sort=" + sort + ", showAble=" + showAble + ", permission=" + permission + "]";
	}
