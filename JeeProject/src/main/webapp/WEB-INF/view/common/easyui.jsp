...
<script type="text/javascript" src="${ctx}/assets/plugins/jquery-easyui-1.5.3/jquery.easyui.min.js"></script>
<script type="text/javascript" src="${ctx}/assets/plugins/insdep/insdep-extend.min.js"></script>
</head>
